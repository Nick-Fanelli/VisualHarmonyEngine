...
namespace HarmonyEngine {
    ...
    struct Log {
        ...
        static void Success(const T& message) {
            if (s_LogLevel >= LogLevelInfo)
                std::cout << ANSI_GREEN_BOLD << "[Harmony Engine Success]: " << ANSI_GREEN << message << ANSI_RESET
                          << std::endl;
        }
        ...
        static void Warn(const T& message) {
            if (s_LogLevel >= LogLevelWarn)
                std::cout << ANSI_YELLOW_BOLD << "[Harmony Engine Warning]: " << ANSI_YELLOW << message << ANSI_RESET
                          << std::endl;
        }
        ...
        static void Error(const T& message) {
            if (s_LogLevel >= LogLevelError)
                std::cout << ANSI_RED_BOLD << "[Harmony Engine Error]: " << ANSI_RED << message << ANSI_RESET
                          << std::endl;
        }
