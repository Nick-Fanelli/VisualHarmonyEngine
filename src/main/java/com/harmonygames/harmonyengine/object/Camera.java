...
public class Camera extends GameObject {
    ...
    public Matrix4f getViewMatrix() {
        ...
        this.viewMatrix.lookAt(new Vector3f(super.transform.position.x, super.transform.position.y, 20.0f),
                cameraFront.add(super.transform.position.x, super.transform.position.y, 0.0f),
                cameraUp);
